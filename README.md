# Senior Full Stack | AI | React | React Native | Shopify | WordPress | Node.js | Python Developer
...
- 🌱 Proficient in front-end technologies like React, React Native, Next.js, Vue.js, Shopify, and WordPress, as well as back-end technologies like Node.js, Python, PHP, and Laravel<br/>
- 🛒 Experienced in Shopify theme customization, Shopify app integrations, Shopify APIs, WooCommerce, WordPress custom themes/plugins, and eCommerce development<br/>
- 🤖 Experienced in AI-powered applications, OpenAI/ChatGPT integrations, AI automation workflows, AI chatbots, recommendation systems, and AI-driven SaaS platforms<br/>
- 👍 Experienced in DevOps, CI/CD, and Cloud infrastructure, especially with AWS, Azure, and GCP<br/>
- 😍 Developed AI apps, AI agents, and intelligent web/mobile solutions integrated with OpenAI and modern AI APIs<br/>
